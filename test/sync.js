(function() {
  ...
  var Library = Chadbone.Collection.extend({
  ...
  test("#1052 - `options` is optional.", 0, function() {
    var model = new Chadbone.Model();
    model.url = '/test';
    Chadbone.sync('create', model);
  });

  test("Chadbone.ajax", 1, function() {
  ...
  test("Call provided error callback on error.", 1, function() {
    var model = new Chadbone.Model;
    model.url = '/test';
    Chadbone.sync('read', model, {
      error: function() { ok(true); }
    });
    this.ajaxSettings.error();
  });

  test('Use Chadbone.emulateHTTP as default.', 2, function() {
    var model = new Chadbone.Model;
    model.url = '/test';

    Chadbone.emulateHTTP = true;
  ...
  test('Use Chadbone.emulateJSON as default.', 2, function() {
    var model = new Chadbone.Model;
    model.url = '/test';

    Chadbone.emulateJSON = true;
    model.sync('create', model);
