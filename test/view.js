(function() {
  ...
  module("Chadbone.View", {

    setup: function() {
      view = new Chadbone.View({
        id        : 'test-view',
        className : 'test-view',
  ...
  test("$el", 3, function() {
    ...
    ok(view.$el instanceof Chadbone.$);
    strictEqual(view.$el[0], view.el);
  });

  test("initialize", 1, function() {
    var View = Chadbone.View.extend({
      initialize: function() {
        this.one = 1;
      }
    });
  ...
  test("delegateEvents", 6, function() {
    ...
    var view = new Chadbone.View({el: '#testElement'});
  ...
  test("delegateEvents allows functions for callbacks", 3, function() {
    var view = new Chadbone.View({el: '<p></p>'});
    view.counter = 0;
  ...
  test("undelegate", 0, function() {
    view = new Chadbone.View({el: '#testElement'});
  ...
  test("#1048 - setElement uses provided object.", 2, function() {
    ...
    var view = new Chadbone.View({el: $el});
    ok(view.$el === $el);
  ...
  test("views stopListening", 0, function() {
    ...
    var view = new View({
      model: new Chadbone.Model,
      collection: new Chadbone.Collection
    });
