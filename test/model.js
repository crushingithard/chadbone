(function() {
  ...
  var proxy = Chadbone.Model.extend();
  var klass = Chadbone.Collection.extend({
    url : function() { return '/collection'; }
  });
  var doc, collection;

  module("Chadbone.Model", {
  ...
  test("underscore methods", 5, function() {
    var model = new Chadbone.Model({ 'foo': 'a', 'bar': 'b', 'baz': 'c' });
  ...
  test("clone", 10, function() {
    var a = new Chadbone.Model({ 'foo': 1, 'bar': 2, 'baz': 3});
    var b = a.clone();
    equal(a.get('foo'), 1);
    equal(a.get('bar'), 2);
    equal(a.get('baz'), 3);
    ...
    var foo = new Chadbone.Model({p: 1});
    var bar = new Chadbone.Model({p: 2});
  ...
  test("isNew", 6, function() {
    ...
    a = new Chadbone.Model({ 'foo': 1, 'bar': 2, 'baz': 3, 'id': -5 });
    ok(!a.isNew(), "any defined ID is legal, negative or positive");
    a = new Chadbone.Model({ 'foo': 1, 'bar': 2, 'baz': 3, 'id': 0 });
    ok(!a.isNew(), "any defined ID is legal, including zero");
    ok( new Chadbone.Model({          }).isNew(), "is true when there is no id");
    ok(!new Chadbone.Model({ 'id': 2  }).isNew(), "is false for a positive integer");
    ok(!new Chadbone.Model({ 'id': -5 }).isNew(), "is false for a negative integer");
  });
  ...
  test("set and unset", 8, function() {
    var a = new Chadbone.Model({id: 'id', foo: 1, bar: 2, baz: 3});
    var changeCount = 0;
  ...
  test("set falsy values in the correct order", 2, function() {
    var model = new Chadbone.Model({result: 'result'});
  ...
  test("set an empty string", 1, function() {
    var model = new Chadbone.Model({name : "Model"});
    model.set({name : ''});
  ...
  test("clear", 3, function() {
    var changed;
    var model = new Chadbone.Model({id: 1, name : "Model"});
  ...
  test("defaults", 4, function() {
    var Defaulted = Chadbone.Model.extend({
      defaults: {
        "one": 1,
        "two": 2
      }
    ...
    Defaulted = Chadbone.Model.extend({
      defaults: function() {
        return {
          "one": 3,
          "two": 4
  ...
  test("change, hasChanged, changedAttributes, previous, previousAttributes", 9, function() {
    var model = new Chadbone.Model({name: "Tim", age: 10});
  ...
  test("changedAttributes", 3, function() {
    var model = new Chadbone.Model({a: 'a', b: 'b'});
    deepEqual(model.changedAttributes(), false);
  ...
  test("change with options", 2, function() {
    var value;
    var model = new Chadbone.Model({name: 'Rob'});
  ...
  test("change after initialize", 1, function () {
    ...
    var obj = new Chadbone.Model(attrs);
  ...
  test("save within change event", 1, function () {
    var env = this;
    var model = new Chadbone.Model({firstName : "Taylor", lastName: "Swift"});
    model.url = '/test';
    model.on('change', function () {
      model.save();
  ...
  test("validate after save", 2, function() {
    var lastError, model = new Chadbone.Model();
  ...
  test("destroy", 3, function() {
    ...
    var newModel = new Chadbone.Model;
  ...
  test("validate on unset and clear", 6, function() {
    var error;
    var model = new Chadbone.Model({name: "One"});
    model.validate = function(attrs) {
      if (!attrs.name) {
        error = true;
        return "No thanks.";
  ...
  test("Inherit class properties", 6, function() {
    var Parent = Chadbone.Model.extend({
  ...
  test("hasChanged/set should use same comparison", 2, function() {
    var changed = 0, model = new Chadbone.Model({a: null});
    model.on('change', function() {
  ...
  test("set value regardless of equality/change", 1, function() {
    var model = new Chadbone.Model({x: []});
    var a = [];
    model.set({x: a});
    ok(model.get('x') === a);
  });
  ...
  test("set same value does not trigger change", 0, function() {
    var model = new Chadbone.Model({x: 1});
  ...
  test("unset does not fire a change for undefined attributes", 0, function() {
    var model = new Chadbone.Model({x: undefined});
  ...
  test("`previous` for falsey keys", 2, function() {
    var model = new Chadbone.Model({0: true, '': true});
  ...
  test("`save` with `wait` sends correct attributes", 5, function() {
    var changed = 0;
    var model = new Chadbone.Model({x: 1, y: 2});
    model.url = '/test';
  ...
  test("#1943 change calculations should use _.isEqual", function() {
    var model = new Chadbone.Model({a: {key: 'value'}});
  ...
  test("isValid", function() {
    var model = new Chadbone.Model({valid: true});
    model.validate = function(attrs) {
