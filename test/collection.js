(function() {
  ...
  module("Chadbone.Collection", {

    setup: function() {
      a         = new Chadbone.Model({id: 3, label: 'a'});
      b         = new Chadbone.Model({id: 2, label: 'b'});
      c         = new Chadbone.Model({id: 1, label: 'c'});
      d         = new Chadbone.Model({id: 0, label: 'd'});
      e         = null;
      col       = new Chadbone.Collection([a,b,c,d]);
      otherCol  = new Chadbone.Collection();
    }
  ...
  test("String comparator.", 1, function() {
    var collection = new Chadbone.Collection([
      {id: 3},
      {id: 1},
      {id: 2}
    ], {comparator: 'id'});
  ...
  test("new and parse", 3, function() {
    var Collection = Chadbone.Collection.extend({
      parse : function(data) {
  ...
  test("clone preserves model and comparator", 3, function() {
    var Model = Chadbone.Model.extend();
    var comparator = function(model){ return model.id; };

    var collection = new Chadbone.Collection([{id: 1}], {
      model: Model,
  ...
  test("get with non-default ids", 5, function() {
    var col = new Chadbone.Collection();
    var MongoModel = Chadbone.Model.extend({idAttribute: '_id'});
    ...
    var col2 = new Chadbone.Collection();
  ...
  test('get with "undefined" id', function() {
    var collection = new Chadbone.Collection([{id: 1}, {id: 'undefined'}]);
  ...
  test("add", 14, function() {
    ...
    e = new Chadbone.Model({id: 10, label : 'e'});
    otherCol.add(e);
    ...
    var f = new Chadbone.Model({id: 20, label : 'f'});
    var g = new Chadbone.Model({id: 21, label : 'g'});
    var h = new Chadbone.Model({id: 22, label : 'h'});
    var atCol = new Chadbone.Collection([f, g, h]);
    ...
    var coll = new Chadbone.Collection(new Array(2));
    var addCount = 0;
  ...
  test("add multiple models", 6, function() {
    var col = new Chadbone.Collection([{at: 0}, {at: 1}, {at: 9}]);
  ...
  test("add; at should have preference over comparator", 1, function() {
    var Col = Chadbone.Collection.extend({
    ...
    col.add(new Chadbone.Model({id: 1}), {at:   1});

    equal(col.pluck('id').join(' '), '3 1 2');
  });

  test("can't add model to collection twice", function() {
    var col = new Chadbone.Collection([{id: 1}, {id: 2}, {id: 1}, {id: 2}, {id: 3}]);
  ...
  test("add model to multiple collections", 10, function() {
    var counter = 0;
    var e = new Chadbone.Model({id: 10, label : 'e'});
    ...
    var colE = new Chadbone.Collection([]);
    colE.on('add', function(model, collection) {
      equal(e, model);
      equal(colE, collection);
    });
    var colF = new Chadbone.Collection([]);
  ...
  test("add model with parse", 1, function() {
    ...
    var Col = Chadbone.Collection.extend({model: Model});
    var col = new Col;
  ...
  test("add model to collection with sort()-style comparator", 3, function() {
    ...
    var tom = new Chadbone.Model({name: 'Tom'});
    var rob = new Chadbone.Model({name: 'Rob'});
    var tim = new Chadbone.Model({name: 'Tim'});
    col.add(tom);
    col.add(rob);
    col.add(tim);
  ...
  test("add and remove return values", 13, function() {
    var Even = Chadbone.Model.extend({
    ...
    equal(list.length, 2);
    ok(list[0] instanceof Chadbone.Model);
  ...
  test("shift and pop", 2, function() {
    var col = new Chadbone.Collection([{a: 'a'}, {b: 'b'}, {c: 'c'}]);
  ...
  test("events are unbound on remove", 3, function() {
    var counter = 0;
    var dj = new Chadbone.Model();
    var emcees = new Chadbone.Collection([dj]);
  ...
  test("remove in multiple collections", 7, function() {
    ...
    var passed = false;
    var e = new Chadbone.Model(modelData);
    var f = new Chadbone.Model(modelData);
    f.on('remove', function() {
      passed = true;
    });
    var colE = new Chadbone.Collection([e]);
    var colF = new Chadbone.Collection([f]);
    ok(e != f);
    ok(colE.length === 1);
    ok(colF.length === 1);
    colE.remove(e);
  ...
  test("remove same model in multiple collection", 16, function() {
    var counter = 0;
    var e = new Chadbone.Model({id: 5, title: 'Othello'});
    ...
    var colF = new Chadbone.Collection([e]);
  ...
  test("Colllection: non-persisted model destroy removes from all collections", 3, function() {
    var e = new Chadbone.Model({title: 'Othello'});
  ...
  test("create with validate:true enforces validation", 3, function() {
    var ValidatingModel = Chadbone.Model.extend({
      validate: function(attrs) {
        return "fail";
      }
    });
    var ValidatingCollection = Chadbone.Collection.extend({
  ...
  test("where and findWhere", 8, function() {
    var model = new Chadbone.Model({a: 1});
    var coll = new Chadbone.Collection([
      model,
      {a: 1},
      {a: 1, b: 2},
      {a: 2, b: 2},
  ...
  test ("reset with different values", function(){
    var col = new Chadbone.Collection({id: 1});
    col.reset({id: 1, a: 1});
    equal(col.get(1).get('a'), 1);
  });

  test("same references in reset", function() {
    var model = new Chadbone.Model({id: 1});
    var collection = new Chadbone.Collection({id: 1});
  ...
  test("reset passes caller options", 3, function() {
    ...
    var col = new (Chadbone.Collection.extend({ model: Model }))();
  ...
  test("add does not alter arguments", 2, function(){
    var attrs = {};
    var models = [attrs];
    new Chadbone.Collection().add(models);
  ...
  test("Invalid models are discarded with validate:true.", 5, function() {
    ...
    collection.model = Chadbone.Model.extend({
  ...
  test("#1112 - passing options.model sets collection.model", 2, function() {
    var Model = Chadbone.Model.extend({});
    var c = new Chadbone.Collection([{id: 1}], {model: Model});
    ok(c.model === Model);
  ...
  test("null and undefined are invalid ids.", 2, function() {
    var model = new Chadbone.Model({id: 1});
    var collection = new Chadbone.Collection([model]);
    model.set({id: null});
  ...
  test("#1412 - Trigger 'request' and 'sync' events.", 4, function() {
    var collection = new Chadbone.Collection;
    collection.url = '/test';
    Chadbone.ajax = function(settings){ settings.success(); };
  ...
  test("#1655 - groupBy can be used with a string argument.", 3, function() {
    var collection = new Chadbone.Collection([{x: 1}, {x: 2}]);
  ...
  test("#1655 - sortBy can be used with a string argument.", 1, function() {
    var collection = new Chadbone.Collection([{x: 3}, {x: 1}, {x: 2}]);
  ...
  test("`sort` shouldn't always fire on `add`", 1, function() {
    var c = new Chadbone.Collection([{id: 1}, {id: 2}, {id: 3}], {
      comparator: 'id'
    });
  ...
  test("set", function() {
    var m1 = new Chadbone.Model();
    var m2 = new Chadbone.Model({id: 2});
    var m3 = new Chadbone.Model();
    var c = new Chadbone.Collection([m1, m2]);
  ...
  test("set + merge with default values defined", function() {
    ...
    var col = new Chadbone.Collection([m], {model: Model});
  ...
  test('merge without mutation', function () {
    ...
    var Collection = Chadbone.Collection.extend({model: Model});
  ...
  test('`set` matches input order in the absence of a comparator', function () {
    var one = new Chadbone.Model({id: 1});
    var two = new Chadbone.Model({id: 2});
    var three = new Chadbone.Model({id: 3});
    var collection = new Chadbone.Collection([one, two, three]);
  ...
  test("`set` with non-normal id", function() {
    var Collection = Chadbone.Collection.extend({
      model: Chadbone.Model.extend({idAttribute: '_id'})
    });
  ...
  test("#1915 - `parse` data in the right order in `set`", function() {
    var collection = new (Chadbone.Collection.extend({
      parse: function (data) {
  ...
  test("#2612 - nested `parse` works with `Collection#set`", function() {
    ...
    var Job = Chadbone.Model.extend({
      constructor: function() {
        this.items = new Items();
        Chadbone.Model.apply(this, arguments);
      },
    ...
    var Item = Chadbone.Model.extend({
      constructor: function() {
        this.subItems = new Chadbone.Collection();
        Chadbone.Model.apply(this, arguments);
      },
      parse: function(attrs) {
    ...
    var Items = Chadbone.Collection.extend({
      model: Item
    });
  ...
  test('_addReference binds all collection events & adds to the lookup hashes', 9, function() {
    ...
    var Collection = Chadbone.Collection.extend({
      ...
      _addReference: function(model) {
        Chadbone.Collection.prototype._addReference.apply(this, arguments);
        calls.add++;
      ...
      _removeReference: function(model) {
        Chadbone.Collection.prototype._removeReference.apply(this, arguments);
        calls.remove++;
